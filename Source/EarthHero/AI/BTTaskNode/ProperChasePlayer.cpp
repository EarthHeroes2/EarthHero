...
UProperChasePlayer::UProperChasePlayer(FObjectInitializer const& ObjectInitializer)
{
	NodeName = "Proper Chase Player";
}

EBTNodeResult::Type UProperChasePlayer::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
